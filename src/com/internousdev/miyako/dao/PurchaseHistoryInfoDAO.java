	...
	public List<PurchaseHistoryInfoDTO> getPurchaseHistoryList(String loginId) {
		...
		try {
			...
			while (resultSet.next()) {
				...
				purchaseHistoryInfoDto.setKana(resultSet.getString("product_name_kana"));
				...
				purchaseHistoryInfoDto.setCompanyName(resultSet.getString("release_company"));
				purchaseHistoryInfoDto.setBuyDate(resultSet.getDate("release_date"));
